 ...
 */
#ifndef QSYNEDIT_PAS_SYNTAXER_H
#define QSYNEDIT_PAS_SYNTAXER_H
#include "syntaxer.h"
#include <QSet>
#include <QMap>
...
class PasSyntaxer: public Syntaxer
{
    enum class TokenId {
        Comment,
        Identifier,
...
public:
    explicit PasSyntaxer();
    PasSyntaxer(const PasSyntaxer&)=delete;
    PasSyntaxer operator=(const PasSyntaxer&)=delete;
