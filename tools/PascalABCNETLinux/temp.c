...
extern const unsigned char assembly_data_testprog_exe [];
static const MonoBundledAssembly assembly_bundle_testprog_exe = {"testprog.exe", assembly_data_testprog_exe, 33280};
extern const unsigned char assembly_data_mscorlib_dll [];
static const MonoBundledAssembly assembly_bundle_mscorlib_dll = {"mscorlib.dll", assembly_data_mscorlib_dll, 901120};
extern const unsigned char assembly_data_System_Numerics_dll [];
static const MonoBundledAssembly assembly_bundle_System_Numerics_dll = {"System.Numerics.dll", assembly_data_System_Numerics_dll, 23552};
extern const unsigned char assembly_data_System_Core_dll [];
static const MonoBundledAssembly assembly_bundle_System_Core_dll = {"System.Core.dll", assembly_data_System_Core_dll, 161280};
extern const unsigned char assembly_data_System_dll [];
static const MonoBundledAssembly assembly_bundle_System_dll = {"System.dll", assembly_data_System_dll, 501760};
extern const unsigned char assembly_data_System_Configuration_dll [];
static const MonoBundledAssembly assembly_bundle_System_Configuration_dll = {"System.Configuration.dll", assembly_data_System_Configuration_dll, 46592};
extern const unsigned char assembly_data_System_Xml_dll [];
static const MonoBundledAssembly assembly_bundle_System_Xml_dll = {"System.Xml.dll", assembly_data_System_Xml_dll, 135680};

static const MonoBundledAssembly *bundled [] = {
	&assembly_bundle_testprog_exe,
...
static char *image_name = "testprog.exe";
